...
extern const String deviceNameStr;
extern const String deviceDescriptionStr;
extern const String deviceLocationStr;
extern const String manufacturerStr;
extern const String yearOfDevelopmentStr;

// Helpers for Board identity
